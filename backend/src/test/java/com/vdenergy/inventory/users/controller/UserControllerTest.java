package com.vdenergy.inventory.users.controller;
...
class UserControllerTest {
    ...
    void createUserSuccessfullyByAdmin() throws Exception {
        ...
        request.setEmail("new.user@vdenergy.es");
        ...
        mockMvc.perform(post("/api/v1/users")
                ...
                .andExpect(jsonPath("$.data.email").value("new.user@vdenergy.es"))
    ...
    void createUserWithDuplicateEmailReturns409() throws Exception {
        ...
        request.setLastName("User");
        request.setEmail("tecnico@vdenergy.es"); // existing email
        request.setPassword("NewPassword123");
        request.setRole(Role.TECNICO);
        ...
        mockMvc.perform(post("/api/v1/users")
                ...
                .andExpect(jsonPath("$.error.message").value("Email already in use: tecnico@vdenergy.es"));
    }
    ...
    void getUserDetailsSuccessfully() throws Exception {
        mockMvc.perform(get("/api/v1/users/" + tecnicoUser.getPublicId())
                ...
                .andExpect(jsonPath("$.data.email").value("tecnico@vdenergy.es"));
    }
    ...
    void updateUserSuccessfully() throws Exception {
        ...
        request.setEmail("tecnico.updated@vdenergy.es");
        ...
        mockMvc.perform(put("/api/v1/users/" + tecnicoUser.getPublicId())
                ...
                .andExpect(jsonPath("$.data.email").value("tecnico.updated@vdenergy.es"))
