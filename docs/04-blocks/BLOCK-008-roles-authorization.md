# BLOCK-008-roles-authorization.md
...
1. Crear Role enum.
2. Aplicar @PreAuthorize.
3. Validar ADMIN/TECNICO.
4. Tests de permisos.

## Archivos/carpetas a crear o modificar

```text
users/entity/Role.java
security config
```
...
```text
docs/99-progress/2026-05-22-block-008.md
```

## Resultado esperado

Al cerrar este bloque, `Roles y permisos` debe estar implementado, validado y documentado.
