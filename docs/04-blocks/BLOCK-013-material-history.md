...
- Crear MaterialHistory entity
- Registrar cambios estado
- Registrar cambios oficina
- Exponer historial
...
1. Crear MaterialHistory entity.
2. Registrar cambios estado.
3. Registrar cambios oficina.
4. Exponer historial.
...
```text
docs/99-progress/2026-05-22-block-013.md
```

## Resultado esperado

Al cerrar este bloque, `Historial materiales` debe estar implementado, validado y documentado.
