...
- Generar QR PNG/SVG
- Crear endpoint QR
- Crear impresión etiqueta básica
...
1. Generar public_code.
2. Generar QR PNG/SVG.
3. Crear endpoint QR.
4. Crear impresión etiqueta básica.
...
```text
docs/99-progress/2026-05-22-block-012.md
```

## Resultado esperado

Al cerrar este bloque, `Sistema QR` debe estar implementado, validado y documentado.
