...
- Crear ApiClient entity
- API key hash
- Scopes
- Rate limiting
- Endpoints users/materials
...
1. Crear ApiClient entity.
2. API key hash.
3. Scopes.
4. Rate limiting.
5. Endpoints users/materials.
...
```text
docs/99-progress/2026-05-22-block-017.md
```

## Resultado esperado

Al cerrar este bloque, `API pública` debe estar implementado, validado y documentado.
