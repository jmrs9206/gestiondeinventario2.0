...
2. MockMvc controllers.
3. Testcontainers MySQL.
4. Security tests.
...
```text
docs/99-progress/2026-05-22-block-022.md
```

## Resultado esperado

Al cerrar este bloque, `Testing backend` debe estar implementado, validado y documentado.
