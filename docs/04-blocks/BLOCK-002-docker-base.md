...
- Crear Dockerfile frontend placeholder
- Crear docker-compose con MySQL
- Crear volumen mysql-data
...
2. Crear Dockerfile frontend placeholder.
3. Crear docker-compose con MySQL.
4. Crear volumen mysql-data.
...
```text
docs/99-progress/2026-05-22-block-002.md
```

## Resultado esperado

Al cerrar este bloque, `Dockerizar base` debe estar implementado, validado y documentado.
