# BLOCK-006-spring-security-base.md
...
- Configurar CORS
- Configurar handlers 401/403
- Bloquear endpoints privados
...
2. Configurar CORS.
3. Configurar handlers 401/403.
4. Bloquear endpoints privados.
...
```text
docs/99-progress/2026-05-22-block-006.md
```

## Resultado esperado

Al cerrar este bloque, `Configurar Spring Security` debe estar implementado, validado y documentado.
