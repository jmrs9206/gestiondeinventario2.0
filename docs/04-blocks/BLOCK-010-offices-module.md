...
```text
docs/99-progress/2026-05-22-block-010.md
```

## Resultado esperado

Al cerrar este bloque, `Módulo oficinas` debe estar implementado, validado y documentado.
