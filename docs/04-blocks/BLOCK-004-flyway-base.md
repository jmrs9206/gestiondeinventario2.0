...
- Añadir dependencia Flyway
- Crear V1__init_schema.sql
- Validar migración en MySQL
...
1. Añadir dependencia Flyway.
2. Crear V1__init_schema.sql.
3. Validar migración en MySQL.
...
Al cerrar este bloque, `Integrar Flyway` debe estar implementado, validado y documentado.
