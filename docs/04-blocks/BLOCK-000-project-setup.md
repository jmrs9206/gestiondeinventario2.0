...
```text
docs/99-progress/2026-05-22-block-000.md
```

## Resultado esperado

Al cerrar este bloque, `Preparación del repositorio` debe estar implementado, validado y documentado.
