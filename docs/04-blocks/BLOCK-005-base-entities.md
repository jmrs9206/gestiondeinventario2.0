...
1. Crear BaseEntity.
2. Definir timestamps.
3. Definir active.
4. Crear enums globales.
...
Al cerrar este bloque, `Crear entidades base` debe estar implementado, validado y documentado.
