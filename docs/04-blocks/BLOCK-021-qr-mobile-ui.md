...
- Redirect login
- Detalle móvil
- Acciones rápidas estado/oficina
...
2. Redirect login.
3. Detalle móvil.
4. Acciones rápidas estado/oficina.

## Archivos/carpetas a crear o modificar

```text
frontend/src/app/i/[publicCode]/**
```
...
```text
docs/99-progress/2026-05-22-block-021.md
```

## Resultado esperado

Al cerrar este bloque, `Flujo móvil QR` debe estar implementado, validado y documentado.
